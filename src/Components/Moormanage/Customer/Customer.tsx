            ...
            <div className="ml-5 mr-4">
              ...
              <div style={{ width: '450px' }} className="flex  flex-col wrapper">
                ...
                <MooringSection
                  ...
                  MooringTableColumn={MooringTableColumn}
                  handleMooringTableRowClick={handleMooringTableRowClick}
                  setSelectedMooring={setSelectedMooring}
                  selectedMooring={selectedMooring}
                  pageNumber2={pageNumber2}
                  pageSizeTwo={pageSizeTwo}
                  totalRecordsTwo={totalRecordsTwo}
                ...
                <WorkOrderSection accordion={accordion} handleToggle={handleToggle} />
                {/* Estimates Section */}
